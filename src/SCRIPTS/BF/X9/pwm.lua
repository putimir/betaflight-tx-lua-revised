return {
   ...
   fields = {
      { x = 65, y = 14, i = 9, min = 0, max = 1, to = SMLSIZE, table = { [0] = "OFF", "ON" }, upd = updateRateTables },
      { x = 65, y = 24, i = 1, min = 1, max = 32, to = SMLSIZE, upd = updatePidRateTable },
      { x = 65, y = 34, i = 2, min = 1, max = 16, to = SMLSIZE, },
