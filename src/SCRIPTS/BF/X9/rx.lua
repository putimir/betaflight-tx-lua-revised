return {
   ...
   fields = {
      ...
      { t = "Cam Angle",  x =  110, y = 20, sp = 50, min = 1000, max = 2000, vals = { 23 }, to = SMLSIZE },
      { t = "Interp",     x =  110, y = 30, sp = 50, min = 1000, max = 2000, vals = { 13 }, to = SMLSIZE },
      { t = "Interp Int", x =  110, y = 40, sp = 50, min = 1000, max = 2000, vals = { 14 }, to = SMLSIZE },
   },
}